...
// Assuming ButtonPrimary and ButtonOutline are imported in App.jsx or main.jsx if they are used elsewhere
// If Contact.jsx is directly rendering these, ensure they are imported here:
// import { ButtonPrimary, ButtonOutline } from "./Button";


const socialLinks = [
  {
    href: 'https://github.com/farukinomaan/',
  ...
  {
    href: 'https://www.linkedin.com/in/nomaanfaruki',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://www.instagram.com/nomaan.faruki',
  ...
  return (
    ...
    >
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form
          // Replace "https://getform.io/f/bnlxrjpb" with your unique Formspree endpoint URL
          action="https://formspree.io/f/xzzvgyyg" 
          method="POST"
          ...
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="nomaan@example.com"
                className="text-field reveal-up"
              />
            </div>
          </div>
